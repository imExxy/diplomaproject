...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.protobuf.internal.more_extensions_pb2', _globals)
if _descriptor._USE_C_DESCRIPTORS == False:
  DESCRIPTOR._options = None
  _globals['_TOPLEVELMESSAGE'].fields_by_name['submessage']._options = None
  _globals['_TOPLEVELMESSAGE'].fields_by_name['submessage']._serialized_options = b'(\001'
  _globals['_TOPLEVELMESSAGE'].fields_by_name['nested_message']._options = None
  _globals['_TOPLEVELMESSAGE'].fields_by_name['nested_message']._serialized_options = b'(\001'
  _globals['_NESTEDMESSAGE'].fields_by_name['submessage']._options = None
  _globals['_NESTEDMESSAGE'].fields_by_name['submessage']._serialized_options = b'(\001'
  _globals['_TOPLEVELMESSAGE']._serialized_start=77
  _globals['_TOPLEVELMESSAGE']._serialized_end=230
  _globals['_NESTEDMESSAGE']._serialized_start=232
  _globals['_NESTEDMESSAGE']._serialized_end=314
  _globals['_EXTENDEDMESSAGE']._serialized_start=316
  _globals['_EXTENDEDMESSAGE']._serialized_end=391
  _globals['_FOREIGNMESSAGE']._serialized_start=393
  _globals['_FOREIGNMESSAGE']._serialized_end=438
