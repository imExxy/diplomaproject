...
static PyObject *__pyx_pf_6pyproj_8_network__set_ca_bundle_path(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_ca_bundle_path) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_set_ca_bundle_path", 1);
...
static int __Pyx_modinit_variable_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportVoidPtr_3_0_6(__pyx_t_1, "PYPROJ_GLOBAL_CONTEXT", (void **)&__pyx_vp_6pyproj_8_datadir_PYPROJ_GLOBAL_CONTEXT, "PJ_CONTEXT *") < 0) __PYX_ERR(2, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
